    ...
    <main className="page">
      <div className="section" style={{ paddingTop: '6rem' }}>
        ...
        <p className="fade-up" style={{ maxWidth: '560px', marginBottom: '3rem', fontSize: '1.05rem', lineHeight: 1.8 }}>
          One of the core skills of an account manager is the ability to identify client needs, build rapport quickly, and translate a product's value into something that matters to that specific business. This project is my attempt to practice that
        </p>
        ...
        <div className="card fade-up" style={{ marginBottom: '1.5rem' }}>
          ...
          <p style={{ lineHeight: 1.8 }}>
            ...
            finding out what a client actually needs, not just what they say they need, and matching to a product. By doing it with 
            local businesses I can build the muscle of writing outreach that gets a reply, running a conversation that surfaces real insight, and turning that insight into a written
             recommendation.
          </p>
        </div>

        {/* Process */}
        <p className="section-label" style={{ margin: '3rem 0 1.5rem' }}>Process</p>
        ...
        <div className="grid-2">
          {[
            { title: 'Cold outreach that actually converts', desc: 'How to write a message that gets a reply from someone who has no reason to say yes.' },
